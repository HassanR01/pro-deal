...
const getProperty = async (id) => {
  ...
  try {
    ...
    if (!res.ok) {
      throw new Error('Caonnot Catch the Property Data')
    }
...
export default async function page({ params }) {
  const { zoneName, propertyName } = params
  const { property } = await getProperty(propertyName)
  const { title, category, image, description, location, position, bathrooms, bedrooms, area, startBudget, zone, developer } = property
  ...
  return (
    <>
      <TitlePage />
      <section>
        <div className="data lg:my-20 w-full flex flex-wrap justify-center items-center">
          <div className="head flex flex-col lg:flex-row items-center justify-around">
            <div className="image p-2 overflow-hidden m-4">
              ...
              <div className="details text-sm sm:text-base my-2 py-2 flex items-center justify-center">
                <div className="rooms flex items-center justify-center mx-2">
                  ...
                  <span className='text-black mr-1 font-bold'>{bedrooms} غرف نوم</span>
                </div>
                <div className="bathrooms flex items-center justify-center mx-2">
                  ...
                  <span className='text-black mr-1 font-bold'>{bathrooms} حمامات</span>
                </div>
                <div className="area flex items-center justify-center mx-2">
                  ...
                  <span className='text-black mr-1 font-bold'>{area} متر مربع</span>
                </div>
              </div>
            </div>
            <div className="mainData relative w-full lg:w-3/5 m-4 p-4">
